...
proc create_root_design { parentCell } {
  ...
  set spi_multidac_dac [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:spi_rtl:1.0 spi_multidac_dac ]
  ...
  # Create instance: spi_multidaq_dac, and set properties
  set spi_multidaq_dac [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_quad_spi:3.2 spi_multidaq_dac ]
  set_property -dict [ list \
   CONFIG.C_FIFO_DEPTH {256} \
  ...
  connect_bd_intf_net -intf_net axi_quad_spi_0_SPI_0 [get_bd_intf_ports spi_multidac_dac] [get_bd_intf_pins spi_multidaq_dac/SPI_0]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins spi_multidaq_dac/AXI_LITE]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins spi_adc/AXI_LITE]
  ...
  connect_bd_intf_net -intf_net spi_adc_SPI_1 [get_bd_intf_ports spi_adc] [get_bd_intf_pins spi_adc/SPI_0]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41E00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs spi_multidaq_dac/AXI_LITE/Reg] SEG_axi_quad_spi_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41E10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs spi_adc/AXI_LITE/Reg] SEG_spi_dac_Reg
